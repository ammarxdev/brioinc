    ...
    <div className="system-layout">
      <aside className="system-sidebar">
        <div className="system-brand">
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: '1.1rem' }}>Brioinc Admin</div>
            <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Superuser Console</div>
          </div>
        </div>

        <nav className="system-nav">
          <a href="#" className="system-nav-item active">
          ...
          <a href="#" className="system-nav-item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="system-footer">
          <a href="#" className="system-nav-item" style={{ padding: '0.5rem 1rem' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
