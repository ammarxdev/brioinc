...
export async function POST(req: Request) {
  try {
    ...
    // If user already exists, we might want to update them to admin anyway
    ...
    // 2. Force create/update user in public.users table as ADMIN
    ...
    return NextResponse.json({ success: true, message: 'Admin account provisioned successfully.' });
  } catch (err: any) {
